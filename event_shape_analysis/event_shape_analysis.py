...
B_plus_arr, B_minus_arr, others_arr = get_final_states("../full_hep_data/hepMCtest")
...
# others
others_final_state_px_arr = []
others_final_state_py_arr = []
others_final_state_pz_arr = []

others_final_state_energy_arr = []
others_final_state_mass_arr = []

for B_meson in others_arr:
    px_s = []
    py_s = []
    pz_s = []
    energy_s = []
    ...
    for final_states in B_meson:
        ...
        energy_s.append(final_state_energy)
        mass_s.append(final_state_mass)
    others_final_state_px_arr.append(px_s)
    others_final_state_py_arr.append(py_s)
    others_final_state_pz_arr.append(pz_s)
    others_final_state_energy_arr.append(energy_s)
    others_final_state_mass_arr.append(mass_s)
...
# others
others_thrust_arr = []
others_sphericity_arr = []
others_aplanarity_arr = []

miss = 0
for i in range(len(others_final_state_px_arr)):
    px = others_final_state_px_arr[i]
    py = others_final_state_py_arr[i]
    pz = others_final_state_pz_arr[i]
    ...
    # Append the computed values to lists
    others_thrust_arr.append(thrust)
    others_sphericity_arr.append(sphericity)
    others_aplanarity_arr.append(aplanarity)
...
plt.hist(thrust_arr, bins=bins, range=range_vals, color='blue', alpha=0.8, label='Signal (Total)')
plt.hist(others_thrust_arr, bins=bins, range=range_vals, color='orange', alpha=0.2, label='Background (Others)')
...
plt.hist(sphericity_arr, bins=bins, range=range_vals, color='blue', alpha=0.8, label='Signal (Total)')
plt.hist(others_sphericity_arr, bins=bins, range=range_vals, color='orange', alpha=0.2, label='Background (Others)')
...
plt.hist(aplanarity_arr, bins=bins, range=range_vals, color='blue', alpha=0.8, label='Signal (Total)')
plt.hist(others_aplanarity_arr, bins=bins, range=range_vals, color='orange', alpha=0.2, label='Background (Others)')
